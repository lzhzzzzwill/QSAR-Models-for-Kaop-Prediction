...
h21 <- read.csv("OH1.csv",header = T,row.names = 1)
h22 <- read.csv("OH2.csv",header = T,row.names = 1)
h23 <- read.csv("OH3.csv",header = T,row.names = 1)
h24 <- read.csv("OH4.csv",header = T,row.names = 1)
...
OH <- read.csv("OH.csv",sep=",",na.strings="NA",stringsAsFactors=FALSE)
...
OH <- read.csv("OH3.csv",sep=",",na.strings="NA",
...
zhudata <- read.csv("OH.csv",sep=",",na.strings="NA",
                     stringsAsFactors=FALSE)
...
OH <- read.csv("OH.csv",header = T,row.names = 1)
...
OH11 <- read.csv("OH1.csv",sep=",",na.strings="NA",stringsAsFactors=FALSE)
